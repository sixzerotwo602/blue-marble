 ...
 *
 * 하이브리드 개발 전략:
 * - 타일 유형: ChatGPT 기반 세분화 (CITY_PROPERTY, NO_BUILD_PROPERTY 분리)
 * - 게임 단계: Gemini 기반 (FIRST_HALF, SECOND_HALF)
 * - 카드 정책: ChatGPT 기반 (keepPolicy, phasePolicy)
 */

// ───────────────────────────────────────────────────────────────
// 타일 유형 (ChatGPT + 부루마블 요소 정리.md 기반)
// ───────────────────────────────────────────────────────────────
